                                ...
                                <div id="action-dropdown-{{ $item->id }}" class="dropdown-menu">
                                    ...
                                    <div id="action-dropdown-{{ $item->id }}-popover" data-popover aria-hidden="true" data-align="end" class="min-w-56">
                                        ...
                                        <div role="group" aria-labelledby="account-options">
                                            <a role="menuitem" href="{{ route('barang-keluar.show', $item->id) }}">
                                                Detail
                                            </a>
                                            <a role="menuitem" href="{{ route('barang-keluar.edit', $item->id) }}">
                                                Ubah
                                            </a>
                                            <form action="{{ route('barang-keluar.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus barang ini?');">
                                                @csrf
                                                @method('DELETE')
