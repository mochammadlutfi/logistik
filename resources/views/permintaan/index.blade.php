<x-app-layout>
    <div class="p-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between gap-2 mb-6">
            ...
            <a href="{{ route('permintaan-barang.create') }}" class="btn btn-sm btn-primary">
                                ...
                                <div id="action-dropdown-{{ $item->id }}" class="dropdown-menu">
                                    ...
                                    <div id="action-dropdown-{{ $item->id }}-popover" data-popover aria-hidden="true" data-align="end" class="min-w-56">
                                        ...
                                        <div role="group" aria-labelledby="account-options">
                                            <a role="menuitem" href="{{ route('permintaan-barang.show', $item->id) }}">
                                                Detail
                                            </a>
                                            <a role="menuitem" href="{{ route('permintaan-barang.edit', $item->id) }}">
                                                Ubah
                                            </a>
                                            <form action="{{ route('permintaan-barang.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus permintaan ini?');">
                                                @csrf
                                                @method('DELETE')
